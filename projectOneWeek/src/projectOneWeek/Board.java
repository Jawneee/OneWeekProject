...
public class Board {
	...
	public void preset1() {
		...
		grid[319].setBackground(Color.WHITE);
		grid[319].setName("tile");
		grid[319].setBackground(Color.BLACK);
		grid[319].setName("wall");
		...
		grid[385].setBackground(Color.WHITE);
		grid[385].setName("tile");
		grid[384].setBackground(Color.WHITE);
		grid[384].setName("tile");
		grid[385].setBackground(Color.BLACK);
		grid[385].setName("wall");
		...
		grid[300].setBackground(Color.WHITE);
		grid[300].setName("tile");
		...
		grid[83].setBackground(Color.BLACK);
		grid[83].setName("wall");
		...
		grid[66].setBackground(Color.BLACK);
		grid[66].setName("wall");
		...
		grid[110].setBackground(Color.BLACK);
		grid[110].setName("wall");
		...
		grid[274].setBackground(Color.BLACK);
		grid[274].setName("wall");
		...
		grid[258].setBackground(Color.BLACK);
		grid[258].setName("wall");
		...
		grid[218].setBackground(Color.BLACK);
		grid[218].setName("wall");
		grid[235].setBackground(Color.BLACK);
		grid[235].setName("wall");
		grid[234].setBackground(Color.BLACK);
		grid[234].setName("wall");
		grid[214].setBackground(Color.BLACK);
		grid[214].setName("wall");
		grid[194].setBackground(Color.BLACK);
		grid[194].setName("wall");
		grid[174].setBackground(Color.BLACK);
		grid[174].setName("wall");
		...
		grid[136].setBackground(Color.BLACK);
		grid[136].setName("wall");
		grid[116].setBackground(Color.BLACK);
		grid[116].setName("wall");
		grid[138].setBackground(Color.BLACK);
		grid[138].setName("wall");
		...
		grid[34].setBackground(Color.BLACK);
		grid[34].setName("wall");
		...
		grid[16].setBackground(Color.yellow);
	...
	public void moveMouse() {
		...
		try {
			if(mousePlaced) {
				...
				if(grid[mousePos+1].getBackground() == Color.yellow) {
					won();
				}else if(grid[mousePos-1].getBackground() == Color.yellow) {
					won();
				...
				if(grid[mousePos-20].getBackground() == Color.gray && grid[mousePos-1].getBackground() == Color.gray && grid[mousePos+1].getBackground() == Color.gray && grid[mousePos+20].getBackground() == Color.black) {
					...
					grayClear();
				}else if(grid[mousePos+20].getBackground() == Color.gray && grid[mousePos-1].getBackground() == Color.gray && grid[mousePos+1].getBackground() == Color.gray && grid[mousePos-20].getBackground() == Color.black) {
					grayClear();
				}
				
				if(grid[mousePos+20].getBackground() == Color.gray && grid[mousePos-1].getBackground() == Color.gray && grid[mousePos+1].getBackground() == Color.black && grid[mousePos-20].getBackground() == Color.BLACK) {
					grayClear();
				...
				if(grid[mousePos-1].getBackground() == Color.gray && grid[mousePos-20].getBackground() == Color.gray && grid[mousePos+20].getBackground() == Color.black && grid[mousePos+1].getBackground() == Color.black) {
					grayClear();
				}else if(grid[mousePos+1].getBackground() == Color.gray && grid[mousePos-20].getBackground() == Color.gray && grid[mousePos+20].getBackground() == Color.black && grid[mousePos-1].getBackground() == Color.black) {
					grayClear();
				}
				...
				if(grid[mousePos+20].getBackground() == Color.gray && grid[mousePos-20].getBackground() == Color.gray && grid[mousePos+1].getBackground() == Color.black && grid[mousePos-1].getBackground() == Color.black) {
					grayClear();
				}else if(grid[mousePos+1].getBackground() == Color.gray && grid[mousePos-1].getBackground() == Color.gray && grid[mousePos+20].getBackground() == Color.black && grid[mousePos-20].getBackground() == Color.black) {
					grayClear();
				}
